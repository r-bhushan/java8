...
public class BinaryOperatorExample {
    ...
    public BinaryOperatorExample applyOperation(BinaryOperator<String> operator) {
        log.info("Example 1 wih string values 'test1' and null, Result is : "+ operator.apply("test1", null));
        log.info("Example 2 wih string values 'test2' and '', Result is : "+operator.apply("test2", ""));
        log.info("Example 1 wih string values 'test3' and 'Test4', Result is : "+operator.apply("test3", "Test4"));
        return this;
    }
